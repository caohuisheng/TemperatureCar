...
public class ChartUtils {
    ...
    public static void showChart(Context context, LineChart lineChart, List<String> xDataList,
        ...
        CustomMarkerView mv = new CustomMarkerView(context, R.layout.chart_marker,unitName);
    ...
    private static LineData setLineData(Context context, List<String> xDataList, List<Entry> yDataList,
        ...
        // 显示颜色
        lineDataSet.setColor(context.getApplicationContext().getResources().getColor(android.R.color.holo_red_light));
        // 圆形的颜色
